...
#         else:
#             return len(strs)
# print(Lenth_words("Hello World"))
# print(Lenth_words("   fly me   to   the moon  "))
# print(Lenth_words("luffy is still joyboy"))
# print(Lenth_words("a"))
